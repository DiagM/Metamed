            ...
            <ul class="dropdown-menu dropdown-menu-end">
              ...
              @endif --}}
                ...
                @else
                    <li>
                        <a class="dropdown-item"
                            href="{{ Route::has('auth-login-basic') ? route('auth-login-basic') : url('auth/login-basic') }}">
...
<script>
    $(document).ready(function() {
        ...
        var $state = states[stateNum],
            $name =
            '{{ Auth::user() ? Auth::user()->name : 'User' }}', // Replace 'name' with the appropriate field from your user object
