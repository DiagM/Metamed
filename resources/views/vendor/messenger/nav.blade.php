...
<ul class="navbar-nav mb-1">
    ...
    <li id="pending_friends_nav" class="nav-item dropdown mx-1 my-2 my-lg-0">
        <a id="click_friends_tab" href="#" class="dropdown-toggle nav-link pt-1 pb-0" data-toggle="dropdown"
        ...
        <div class="dropdown-menu dropdown-menu-right notify-drop bg-light" aria-labelledby="click_friends_tab">
            <div class="row">
                <div class="col-12 pill-tab-nav">
                    <nav id="nav-friend-tabs" class="nav nav-pills flex-column flex-sm-row" role="tablist">
                        <a class="flex-sm-fill text-sm-center nav-link h6 active" id="tab-pending" data-toggle="pill"
                            href="#f_pending" role="tab" aria-controls="f_pending" aria-selected="true"><i
                                class="fas fa-user-friends"></i> Pending</a>
                        <a class="flex-sm-fill text-sm-center nav-link h6" id="tab-sent" data-toggle="pill"
                            href="#f_sent" role="tab" aria-controls="f_sent" aria-selected="false"><i
            ...
            <div class="col-12 text-center mt-2 pb-4 pb-lg-3">
                <hr class="mb-1 mt-0">
                <span class="float-right"><a class="nav-search-link text-dark" href="#"><i
                            class="fas fa-search"></i> Find Friends</a></span>
            </div>
        </div>
    </li>
    <li class="nav-item dropdown">
        <a id="user_nav_dp" href="#" class="dropdown-toggle nav-link pb-lg-0" data-toggle="dropdown"
            role="button" aria-expanded="false">
            <img class="rounded align-top my-n2 my-global-avatar" id="navProf_pic" height="38" width="38"
        ...
        <div class="dropdown-menu dropdown-menu-right" aria-labelledby="user_nav_dp">
            <a onclick="Messenger.forms().Logout(); return false;" class="dropdown-item" href="#"><i
