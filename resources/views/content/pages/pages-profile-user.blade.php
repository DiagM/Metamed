...
@section('page-script')
    ...
    @vite(['resources/assets/js/pages-profile.js', 'resources/assets/js/modal-edit-profile.js', 'resources/js/laravel-holiday.js', 'resources/js/laravel-holiday-edit.js'])
@endsection
...
@section('content')
                ...
                <div class="user-profile-header d-flex flex-column flex-sm-row text-sm-start text-center mb-4">
                    @if ($user->picture)
                        <div class="flex-shrink-0 mt-n2 mx-sm-0 mx-auto">
                            ...
                            <img src="{{ asset('/messenger/assets/provider/user/' . $user->id . '/sm/' . $user->picture) }}"
                                class="d-block h-auto ms-0 ms-sm-4 rounded user-profile-img" alt="User Picture">
                            ...
                            <div class="user-profile-info">
                                ...
                                <ul
                                    ...
                                    <li class="list-inline-item d-flex gap-1">
                                        <i class='ti ti-color-swatch'></i> {{ auth()->user()->getRoleNames()->first() }}
                                    </li>
                                    <li class="list-inline-item d-flex gap-1">
                                        <i class='ti ti-calendar'></i>Joined {{ $user->created_at->format('Y-m-d') }}
            ...
            <div class="card mb-4">
                <div class="card-body">
                    ...
                    <ul class="list-unstyled mb-4 mt-3">
                        ...
                        <li class="d-flex align-items-center mb-3"><i class="ti ti-check text-heading"></i><span
                                class="fw-medium mx-2 text-heading">Licence number:</span>
                    ...
                    <ul class="list-unstyled mb-4 mt-3">
                        <li class="d-flex align-items-center mb-3"><i class="ti ti-phone-call"></i><span
                                class="fw-medium mx-2 text-heading">Contact:</span> <span>{{ $user->contact }}</span></li>
    ...
    @hasrole('doctor')
        <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasAddHoliday" aria-labelledby="offcanvasAddHolidayLabel">
            <div class="offcanvas-header">
                <h5 id="offcanvasAddHolidayLabel" class="offcanvas-title">Add Holiday</h5>
                <button type="button" class="btn-close text-reset" data-bs-dismiss="offcanvas" aria-label="Close"></button>
            </div>
            <div class="offcanvas-body mx-0 flex-grow-0">
                <form class="add-new-holiday pt-0" id="addNewHolidayForm">
                    <input type="hidden" name="id" id="holiday_id">

                    <div class="mb-3">
                        <label class="form-label" for="add-holiday-reason">Reason</label>
                        <input type="text" class="form-control" id="add-holiday-reason" placeholder="Reason" name="reason"
                            aria-label="Reason" />
                    </div>
                    <div class="mb-3">
                        <label class="form-label" for="add-holiday-start-date">Start Date</label>
                        <input type="date" id="add-holiday-start-date" class="form-control" name="start_date"
                            aria-label="Start Date" />
                    </div>
                    <div class="mb-3">
                        <label class="form-label" for="add-holiday-end-date">End Date</label>
                        <input type="date" id="add-holiday-end-date" class="form-control" name="end_date"
                            aria-label="End Date" />
                    </div>
    ...
    @endhasrole
    @hasrole('department')
        <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasEditHoliday"
            aria-labelledby="offcanvasEditHolidayLabel">
            <div class="offcanvas-header">
                <h5 id="offcanvasEditHolidayLabel" class="offcanvas-title">Edit Holiday</h5>
                <button type="button" class="btn-close text-reset" data-bs-dismiss="offcanvas" aria-label="Close"></button>
            </div>
            <div class="offcanvas-body mx-0 flex-grow-0">
                <form class="edit-holiday pt-0" id="editHolidayForm">
                    <input name="id" id="holiday_id" hidden>

                    <div class="mb-3">
                        <label class="form-label" for="edit-holiday-reason">Reason</label>
                        <input type="text" class="form-control" id="edit-holiday-reason" placeholder="Reason"
                            name="reason" aria-label="Reason" readonly />
                    </div>
                    <div class="mb-3">
                        <label class="form-label" for="edit-holiday-start-date">Start Date</label>
                        <input type="text" id="edit-holiday-start-date" class="form-control" name="start_date"
                            aria-label="Start Date" readonly />
                    </div>
                    <div class="mb-3">
                        <label class="form-label" for="edit-holiday-end-date">End Date</label>
                        <input type="text" id="edit-holiday-end-date" class="form-control" name="end_date"
                            aria-label="End Date" readonly />
                    </div>
                    <div class="mb-3">
                        <label class="form-label" for="edit-holiday-status">Status</label>
                        <select class="form-select" id="edit-holiday-status" name="status" aria-label="Status">
    ...
    <!--/ User Profile Content -->
    <!-- Modal -->
    @include('_partials/_modals/modal-edit-profile')
