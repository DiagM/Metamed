...
$(function () {
  ...
  var dt_user_table = $('.datatable-project'),
    ...
    offCanvasForm = $('#offcanvasAddMedicalFile');
...
$(document).on('click', '.download-record', function () {
  ...
  $(document).on('click', '.edit-record', function () {
    ...
    $('#offcanvasAddMedicalFileLabel').html('Edit File');
  ...
  $('.add-new').on('click', function () {
    ...
    $('#offcanvasAddMedicalFileLabel').html('Add File');
  ...
  const addNewMedicalFileForm = document.getElementById('addNewMedicalFileForm');

  // user form validation
  const fv = FormValidation.formValidation(addNewMedicalFileForm, {
    fields: {
      file_name: {
        validators: {
          notEmpty: {
...
var formData = new FormData($('#addNewMedicalFileForm')[0]);

// Append additional data if needed
formData.append('id', $('#medical_file_id').val());
var $userid = window.userData.id;
formData.append('patient_id', $userid);
formData.append('file_name', $('#add-medical-file-name').val());
formData.append('description', $('#add-medical-file-description').val());
formData.append('medical_file', $('#add-medical-file')[0].files[0]); // Append the file object
