...
$(function () {
  ...
  var dt_user_table = $('.datatables-users'),
    ...
    offCanvasForm = $('#offcanvasAddHospital');
  ...
  if (dt_user_table.length) {
    var dt_user = dt_user_table.DataTable({
        ...
        },
        {
          ...
          render: function (data, type, full, meta) {
            ...
            return (
              ...
              `<button class="btn btn-sm btn-icon edit-record" data-id="${full['id']}" data-bs-toggle="offcanvas" data-bs-target="#offcanvasAddHospital"><i class="ti ti-edit"></i></button>` +
      ...
      buttons: [
        ...
        {
          text: '<i class="ti ti-plus me-0 me-sm-1"></i><span class="d-none d-sm-inline-block">Add New Hospital</span>',
          className: 'add-new btn btn-primary waves-effect waves-light',
          attr: {
            'data-bs-toggle': 'offcanvas',
            'data-bs-target': '#offcanvasAddHospital'
          }
        }
      ],
...
$('#filter-department').change(function () {
  ...
  $(document).on('click', '.delete-record', function () {
    ...
    Swal.fire({
      ...
      if (result.value) {
        ...
        $.ajax({
          type: 'DELETE',
          url: `${baseUrl}hospital-list/${user_id}`,
          success: function () {
            dt_user.draw();
          },
  ...
  $(document).on('click', '.view-record', function(event) {
    ...
    $.ajax({
        url: '/hospital-list/' + hospitalId, // Adjust the URL according to your route setup
        method: 'GET',
        success: function(response) {
            // Handle the successful response, for example, redirecting to the show page
            window.location.href = '/hospital-list/' + hospitalId;
        },
  ...
  $(document).on('click', '.edit-record', function () {
    ...
    $('#offcanvasAddHospitalLabel').html('Edit Hospital');

    // get data
    $.get(`${baseUrl}hospital-list\/${user_id}\/edit`, function (data) {

      $('#hospital_id').val(data.id);
      $('#add-hospital-name').val(data.name);
      $('#add-hospital-email').val(data.email);
      $('#add-hospital-contact').val(data.contact);
    });
  });
  ...
  $('.add-new').on('click', function () {
    ...
    $('#offcanvasAddHospitalLabel').html('Add Hospital');
  ...
  const addNewHospitalForm = document.getElementById('addNewHospitalForm');

  // user form validation
  const fv = FormValidation.formValidation(addNewHospitalForm, {
    fields: {
      name: {
        validators: {
          notEmpty: {
    ...
    $.ajax({
      data: $('#addNewHospitalForm').serialize(),
      url: `${baseUrl}hospital-list`,
      type: 'POST',
      success: function (status) {
        ...
        Swal.fire({
          ...
          text: `Hospital ${status} Successfully.`,
          customClass: {
            confirmButton: 'btn btn-success'
          }
        });
