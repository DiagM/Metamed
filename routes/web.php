...
Route::middleware(['auth'])->group(function () {
  ...
  Route::get('/layouts/horizontal', [Horizontal::class, 'index'])->name('dashboard-analytics-horizontal');
  Route::get('/layouts/vertical', [Vertical::class, 'index'])->name('dashboard-analytics-vertical');
